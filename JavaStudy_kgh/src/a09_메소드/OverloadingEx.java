...
public class OverloadingEx {
	 ...
	 * 
	 * 문자열의 형변환
	 * 1. 문자열 -> int, double로 바꾸고 싶을때
	 * Integer.parseInt("1000000"); 문자열을 정수로 변환
	 * Double.parseDouble("1000000.1"); 문자열을 실수로 변환
	 * Long, Boolean도 마찬가지로 가능
	 * 
	 * 2. int, double -> 문자열
	 * Integer.toString(1000000); 정수를 문자열로 변환
	 * Double.toString(1000000.0); 실수를 문자열로 변환, 예시 : *System.out.println(Integer.toString(100005555));
	 * Long, Boolean도 마찬가지로 가능
	 */
